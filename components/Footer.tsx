    ...
    <footer className="bg-white text-gray-500">
      <div className="max-w-[1320px] mx-auto px-6 py-14">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
            ...
            <div className="flex gap-3">
              {["facebook", "twitter", "instagram", "youtube"].map((social) => (
                <a
                  key={social}
                  href="#"
                  className="w-9 h-9 rounded-full bg-gray-100 flex items-center justify-center hover:bg-gray-200 transition-colors duration-200"
                  aria-label={social}
                >
                  {social === "facebook" && (
          ...
          {/* Dogs */}
          <div>
            <h4 className="font-heading text-base text-dark mb-4 flex items-center gap-1.5">
          ...
          {/* Company */}
          <div>
            <h4 className="font-heading text-base text-dark mb-4">Company</h4>
            <ul className="space-y-2.5">
